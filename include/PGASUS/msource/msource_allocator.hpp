...
public:
	...
	template <class U> MemSourceAllocator& operator=(const MemSourceAllocator<U>& other) {
		ms = other.ms; return *this; }
	template <class U> MemSourceAllocator& operator=(MemSourceAllocator<U>&& other) {
			ms = other.ms; return *this; }
